...
class Product
{
     ...
     * @var string
     *
     * @ORM\Column(name="description_formatter", type="text", nullable= true)
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="\Application\Sonata\MediaBundle\Entity\Gallery", inversedBy="product")
     */
    private $gallery;
